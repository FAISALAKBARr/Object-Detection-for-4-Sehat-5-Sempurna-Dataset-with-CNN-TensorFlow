...
def main():
    ...
    with tab2:
        st.header("Upload Gambar untuk Analisis")
        uploaded_file = st.file_uploader("Pilih gambar makanan/minuman...", type=["jpg", "jpeg", "png"])
        ...
        if uploaded_file is not None:
            ...
            if result:
                ...
                with col2:
                    ...
                    primary_class = result['class']
                    st.markdown(class_descriptions[primary_class])
